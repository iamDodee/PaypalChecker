tools ini bertujuan untuk mengecek balance Paypal
...
Status => Valid
Balance => 89$
} => menandakan paypal anda Valid dengan saldo 89$
jika 
{false;null
Status => Error
Balance => Blank
} => menandakan paypal anda error alias Salah (dimohon periksa kembali)
